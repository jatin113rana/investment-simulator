...
16. **Exclusive Tailwind CSS**: Never introduce custom global CSS rules or custom CSS classes in `globals.css` or component stylesheets. Use 100% Tailwind CSS utility classes exclusively across the entire codebase. Ensure all UI layouts are fully responsive across mobile, tablet, and desktop viewports with a clean, modern, and accessible design.
