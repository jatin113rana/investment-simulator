...
export default function Home() {
  ...
  const clerkAppearance = {
    elements: {
      ...
      header: "hidden",
      formButtonPrimary:
        "w-full bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-sm rounded-xl py-3 shadow-md shadow-emerald-600/25 active:scale-[0.98] transition-all cursor-pointer border-0 mt-2",
      formFieldInput:
        "w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm text-slate-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all bg-slate-50/70 focus:bg-white",
      ...
      socialButtonsBlockButton:
        "border border-slate-200 hover:bg-slate-50/80 rounded-xl text-slate-700 font-semibold text-xs transition-all shadow-xs py-2.5 bg-white flex items-center justify-center gap-2",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-5 bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-md transition-all">
          ...
          <div className="lg:col-span-5 w-full max-w-md mx-auto">
            <div className="relative rounded-3xl bg-white/90 p-6 sm:p-8 backdrop-blur-xl border border-slate-200/80 shadow-2xl shadow-slate-200/60 transition-all overflow-hidden">
              ...
              {!isLoaded || (isSignedIn && redirecting) ? (
                ...
                <div>
                  {/* Clean Tab Switcher */}
                  <div className="flex rounded-2xl bg-slate-100/90 p-1.5 mb-6 border border-slate-200/80 shadow-inner">
                    <button
                  ...
                  <div className="mt-5 pt-4 border-t border-slate-200/80 text-center">
                    <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 rounded-xl text-[11px] font-semibold text-slate-600">
